...
const OrganizeEventPage = () => {
	const { onSecondaryPurchaseTicket, uploadJSONToIPFS, fetchEventDetails } =
	...
	useEffect(() => {
		const onReload = () => {
			...
			setTicketId(window.location.pathname.split("/")[3].parseInt());
		};
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			await onSecondaryPurchaseTicket(
